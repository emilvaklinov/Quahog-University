...
public class Runner {
    public static void main(String[] args) {
        ...
        Student student1 = new Student("Camila", 22, 01010, mentor1);
        DBHelper.save(student1);
        Student student2 = new Student("Allen", 27, 01011, mentor2);
        DBHelper.save(student2);
        Student student3 = new Student("Pamela", 20, 01012, mentor2);
        DBHelper.save(student3);
        Student student4 = new Student("Kat", 30, 01013, mentor1);
        DBHelper.save(student4);
        Student student5 = new Student("Robby", 25, 01014, mentor1);
        DBHelper.save(student5);

        Lesson lesson1 = new Lesson("SQL", 2);
        DBHelper.save(lesson1);
        Lesson lesson2 = new Lesson("Java", 1);
